...
namespace Realestate_portal.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Customer,Name,LastName,Gender,Birthday,Marital_status,Type,Email,Phone,Mobile,Country,State,City,Address,Zipcode,Lead,ID_User,Active,ID_Company,Creation_date")] Tb_Customers tb_Customers)
        {
            Sys_Users activeuser = Session["activeUser"] as Sys_Users;
            ...
            tb_Customers.ID_User = activeuser.ID_User;
            tb_Customers.User_assigned = activeuser.Name + " " + activeuser.LastName;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Customer,Name,LastName,Gender,Birthday,Marital_status,Type,Email,Phone,Mobile,Country,State,City,Address,Zipcode,Lead,ID_User,User_assigned,Active,ID_Company,Creation_date")] Tb_Customers tb_Customers)
        {
            try
            {
                if (tb_Customers.Zipcode == null) { tb_Customers.Zipcode = ""; }
                ...
                return RedirectToAction("Edit", "Customers", new { id=tb_Customers.ID_Customer});
            }
            catch (Exception ex) {
