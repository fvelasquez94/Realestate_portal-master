...
namespace Realestate_portal.Controllers
{
    public class PortalController : Controller
    {
        ...
        public ActionResult SendPackage(int idpackage)
        {
            try
            {
                ...
                if (activeuser != null)
                {
                    ...
                    if (docpackage != null)
                    {
                        ...
                        try
                        {
                            ...
                            if (brokeremail != null && brokeremail != "")
                            {
                                ...
                                TempData["exito"] = "Data saved but email was not configured.";
                            }
                    ...
                    TempData["advertencia"] = "No user data was found.";
                }
                ...
                return RedirectToAction("Package_details", "Portal", new { idpackage = idpackage });
            }
            catch (Exception ex)
            {
        ...
        public ActionResult UploadVideo(string title, string url, string description, string category)
        {
            ...
            try
            {
                for (int i = 0; i < Request.Files.Count; i++)
                {
                    ...
                    path = Path.Combine(Server.MapPath("~/Content/Uploads/Images/Videos_img/"), fileName);
                    file.SaveAs(path);
                }
            }
            catch {
            ...
            try {
                ...
                newvideo.T_image = "~/Content/Uploads/Images/Videos_img/" + fileName;
        ...
        public ActionResult EditVideo(int id, string title, string url, string description, string category)
        {
            ...
            try
            {
                ...
                {
                    editvideo.T_image = "~/Content/Uploads/Images/Videos_img/" + fileName;
                }
  ...
  //Metodo para que los agentes agreguen paquetes
            try
            {
                ...
                newpackage.ID_Property = Convert.ToInt32(customerfromProp.ID_Property);


                //buscamos los detalles
                List<Tb_Docpackages_details> lsttosave = new List<Tb_Docpackages_details>();

                var details = (from a in db.Tb_Docpackages_details where (a.ID_docpackage == idpackage && a.original == true) select a).ToList();
                ...
                foreach (var item in details) {
                    item.original = false;
                    item.ID_docpackage = newpackage.ID_docpackage;
                    lsttosave.Add(item);
                }
        ...
        public ActionResult DeletePackage(int id)
        {
            try
            {
                ...
                TempData["exito"] = "Package deleted successfully.";
